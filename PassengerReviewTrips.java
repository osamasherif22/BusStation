...
public class PassengerReviewTrips extends JFrame {
	 ...
	 * @param customer 
	 */
	public PassengerReviewTrips(Customer customer) {
		setTitle("Single Trips");
		...
		btnView.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				customer.getCustomerTickets().forEach(Ticket ->        // populate produce combo box with one to length of produce names array
		        {
		        	...
		        	{
  if (Ticket.getTicketType().equalsIgnoreCase("R"))
	  btnGoToBack.setEnabled(true);
textArea.setText(Ticket.getTrip1().getDestination());
textArea_1.setText(Ticket.getTrip1().getSource());
textArea_2.setText(Ticket.getTrip1().getDate());
textArea_3.setText(Ticket.getTrip1().getTime());
textArea_4.setText(Ticket.getTrip1().getVehicleType().getVehicleType());
textArea_5.setText(String.valueOf(Ticket.getbookedSeats()));
		...
		btnPrevious.setBounds(67, 227, 105, 20);
	   ...
	   textArea_5 = new JTextArea();
		...
		contentPane.add(textArea_5);
		 ...
		 btnGoToBack = new JButton("Go To Back Trip");
		 btnGoToBack.setEnabled(false);
		btnGoToBack.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				PassengerreviewRoundTickets passengerreviewRoundTickets = new PassengerreviewRoundTickets(customer);
				passengerreviewRoundTickets.setVisible(true);
				setVisible(false);
			}
		});
		btnGoToBack.setFont(new Font("Consolas", Font.PLAIN, 15));
		btnGoToBack.setBounds(244, 227, 167, 20);
		contentPane.add(btnGoToBack);
